import unittest
from specialized.detector_support.ramp import normalize_rgb_gradient, make_rgb_lut, blend
...
class TestNormalizeGradient(unittest.TestCase):
    def test_simple(self):
        ...
        self.assertEqual(exp, list(normalize_rgb_gradient(arg)))
...
class TestLUTHelper(unittest.TestCase):
    def test_simple(self):
        ...
        exp = list(enumerate(zip(exp_r, exp_g, exp_b)))
